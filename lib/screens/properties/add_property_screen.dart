...
/// Screen for adding new properties
...
class _AddPropertyScreenState extends State<AddPropertyScreen>
    with PropertyFormMixin<AddPropertyScreen> {
  @override
  void initState() {
    super.initState();
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label:
                      Text(isProcessingImage ? 'Processing...' : 'Add Image'),
  ...
  Future<void> _handleSave() async {
    await saveProperty(null); // null because we're adding a new property
    ...
    if (widget.onSave != null) {
      ...
      // Ensure we land on properties dashboard
